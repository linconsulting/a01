...
void outVars(){
    ...
    String strOut = now.day() > 9 ? String(now.day()) : "0"+String(now.day());
    strOut += "/";
    strOut += now.month() > 9 ? String(now.month()) : "0"+String(now.month());
    strOut += "/";
    strOut += String(now.year());
    strOut += " ";
    strOut += now.hour() > 9 ? String(now.hour()) : "0"+String(now.hour());
    strOut += ":";
    strOut += now.minute() > 9 ? String(now.minute()) : "0"+String(now.minute()) + " ";

    Serial.print(strOut);

    String strVars = "-startTimeP1 = ";
    Serial.print(strVars);

    strVars += startTimeP1.day() > 9 ? String(startTimeP1.day()) : "0"+String(startTimeP1.day()) + "/";
    strVars += startTimeP1.month() > 9 ? String(startTimeP1.month()) : "0"+String(startTimeP1.month()) + "/";
    strVars += String(startTimeP1.year()) + " ";
